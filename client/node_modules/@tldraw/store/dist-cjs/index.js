...
__export(src_exports, {
  ...
  StoreQueries: () => import_StoreQueries.StoreQueries,
  StoreSchema: () => import_StoreSchema.StoreSchema,
  StoreSideEffects: () => import_StoreSideEffects.StoreSideEffects,
  assertIdType: () => import_RecordType.assertIdType,
  createComputedCache: () => import_Store.createComputedCache,
  createEmptyRecordsDiff: () => import_RecordsDiff.createEmptyRecordsDiff,
  createMigrationIds: () => import_migrate.createMigrationIds,
  ...
  reverseRecordsDiff: () => import_RecordsDiff.reverseRecordsDiff,
  squashRecordDiffs: () => import_RecordsDiff.squashRecordDiffs,
  squashRecordDiffsMutable: () => import_RecordsDiff.squashRecordDiffsMutable
});
