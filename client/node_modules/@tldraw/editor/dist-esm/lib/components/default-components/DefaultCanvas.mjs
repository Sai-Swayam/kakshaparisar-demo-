...
function ShapesWithSVGs() {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: renderingShapes.map((result) => /* @__PURE__ */ jsxs(Fragment2, { children: [
...
function ShapesToDisplay() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    editor.environment.isSafari && /* @__PURE__ */ jsx(ReflowIfNeeded, {})
  ] });
}
function ShapeIndicators() {
  ...
  if (!ShapeIndicator)
    return null;
  return /* @__PURE__ */ jsx(Fragment, { children: renderingShapes.map(({ id }) => /* @__PURE__ */ jsx(ShapeIndicator, { shapeId: id, hidden: !idsToDisplay.has(id) }, id + "_indicator")) });
}
