...
function DefaultCanvas({ className }) {
  ...
  const hideShapes = (0, import_state.useValue)("debug_shapes", () => import_debug_flags.debugFlags.hideShapes.get(), [import_debug_flags.debugFlags]);
  const debugSvg = (0, import_state.useValue)("debug_svg", () => import_debug_flags.debugFlags.debugSvg.get(), [import_debug_flags.debugFlags]);
  const debugGeometry = (0, import_state.useValue)("debug_geometry", () => import_debug_flags.debugFlags.debugGeometry.get(), [
    import_debug_flags.debugFlags
  ]);
  const isEditingAnything = (0, import_state.useValue)(
    "isEditingAnything",
    () => editor.getEditingShapeId() !== null,
    [editor]
  );
  const isSelectingAnything = (0, import_state.useValue)(
    "isSelectingAnything",
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "tl-overlays", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { ref: rHtmlLayer2, className: "tl-html-layer", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShapeIndicators, {}),
...
function GridWrapper() {
  const editor = (0, import_useEditor.useEditor)();
  const gridSize = (0, import_state.useValue)("gridSize", () => editor.getDocumentSettings().gridSize, [editor]);
  const { x, y, z } = (0, import_state.useValue)("camera", () => editor.getCamera(), [editor]);
  const isGridMode = (0, import_state.useValue)("isGridMode", () => editor.getInstanceState().isGridMode, [editor]);
...
function ScribbleWrapper() {
  const editor = (0, import_useEditor.useEditor)();
  const scribbles = (0, import_state.useValue)("scribbles", () => editor.getInstanceState().scribbles, [editor]);
  const zoomLevel = (0, import_state.useValue)("zoomLevel", () => editor.getZoomLevel(), [editor]);
  const { Scribble } = (0, import_useEditorComponents.useEditorComponents)();
  if (!(Scribble && scribbles.length))
    return null;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: scribbles.map((scribble) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    Scribble,
    {
...
function BrushWrapper() {
  const editor = (0, import_useEditor.useEditor)();
  const brush = (0, import_state.useValue)("brush", () => editor.getInstanceState().brush, [editor]);
...
function ZoomBrushWrapper() {
  const editor = (0, import_useEditor.useEditor)();
  const zoomBrush = (0, import_state.useValue)("zoomBrush", () => editor.getInstanceState().zoomBrush, [editor]);
...
function SnapIndicatorWrapper() {
  const editor = (0, import_useEditor.useEditor)();
  const lines = (0, import_state.useValue)("snapLines", () => editor.snaps.getIndicators(), [editor]);
  const zoomLevel = (0, import_state.useValue)("zoomLevel", () => editor.getZoomLevel(), [editor]);
  const { SnapIndicator } = (0, import_useEditorComponents.useEditorComponents)();
  if (!(SnapIndicator && lines.length > 0))
    return null;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: lines.map((line) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SnapIndicator, { className: "tl-user-snapline", line, zoom: zoomLevel }, line.id)) });
}
function HandlesWrapper() {
  const editor = (0, import_useEditor.useEditor)();
  const shapeIdWithHandles = (0, import_state.useValue)(
...
function HandlesWrapperInner({ shapeId }) {
  ...
  const zoomLevel = (0, import_state.useValue)("zoomLevel", () => editor.getZoomLevel(), [editor]);
  const isCoarse = (0, import_state.useValue)("coarse pointer", () => editor.getInstanceState().isCoarsePointer, [
    editor
  ]);
  const transform = (0, import_state.useValue)("handles transform", () => editor.getShapePageTransform(shapeId), [
    editor,
    shapeId
  ]);
...
function ShapesWithSVGs() {
  const editor = (0, import_useEditor.useEditor)();
  const renderingShapes = (0, import_state.useValue)("rendering shapes", () => editor.getRenderingShapes(), [editor]);
  const dprMultiple = (0, import_state.useValue)(
    "dpr multiple",
    () => (
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: renderingShapes.map((result) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_react.Fragment, { children: [
...
function ShapesToDisplay() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    editor.environment.isSafari && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReflowIfNeeded, {})
  ] });
}
function ShapeIndicators() {
  ...
  const idsToDisplay = (0, import_state.useValue)(
  ...
  if (!ShapeIndicator)
    return null;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: renderingShapes.map(({ id }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShapeIndicator, { shapeId: id, hidden: !idsToDisplay.has(id) }, id + "_indicator")) });
}
function HintedShapeIndicator() {
  const editor = (0, import_useEditor.useEditor)();
  const { ShapeIndicator } = (0, import_useEditorComponents.useEditorComponents)();
  const ids = (0, import_state.useValue)("hinting shape ids", () => (0, import_utils.dedupe)(editor.getHintingShapeIds()), [editor]);
  if (!ids.length)
    return null;
  if (!ShapeIndicator)
    return null;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: ids.map((id) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShapeIndicator, { className: "tl-user-indicator__hint", shapeId: id }, id + "_hinting")) });
}
function CursorDef() {
...
function DebugSvgCopy({ id }) {
  ...
  const isInRoot = (0, import_state.useValue)(
    "is in root",
    () => {
...
function SelectionForegroundWrapper() {
  const editor = (0, import_useEditor.useEditor)();
  const selectionRotation = (0, import_state.useValue)("selection rotation", () => editor.getSelectionRotation(), [
    editor
  ]);
  const selectionBounds = (0, import_state.useValue)(
    "selection bounds",
...
function MovingCameraHitTestBlocker() {
  const editor = (0, import_useEditor.useEditor)();
  const cameraState = (0, import_state.useValue)("camera state", () => editor.getCameraState(), [editor]);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "div",
    {
