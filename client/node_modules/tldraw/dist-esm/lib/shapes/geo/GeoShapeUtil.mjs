...
class GeoShapeUtil extends BaseBoxShapeUtil {
  ...
  component(shape) {
    ...
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(SVGContainer, { id, children: /* @__PURE__ */ jsx(GeoShapeBody, { shape, shouldScale: true }) }),
  ...
  indicator(shape) {
    ...
    switch (props.geo) {
      case "ellipse": {
        if (props.dash === "draw") {
          return /* @__PURE__ */ jsx("path", { d: getEllipseDrawIndicatorPath(id, w, h, strokeWidth) });
        }
        return /* @__PURE__ */ jsx("path", { d: geometry.getSvgPathData(true) });
      }
      case "heart": {
        return /* @__PURE__ */ jsx("path", { d: getHeartPath(w, h) });
      }
      case "oval": {
        return /* @__PURE__ */ jsx("path", { d: geometry.getSvgPathData(true) });
      }
      case "cloud": {
        return /* @__PURE__ */ jsx("path", { d: getCloudPath(w, h, id, size) });
      }
      default: {
  ...
  toSvg(shape, ctx) {
    ...
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(GeoShapeBody, { shouldScale: false, shape: newShape }),
      textEl
    ] });
  }
  getCanvasSvgDefs() {
