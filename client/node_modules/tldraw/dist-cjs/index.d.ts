 ...
 * @public
 */
export declare function copyAs(editor: Editor, ids: TLShapeId[], format?: TLCopyType, opts?: TLSvgOptions): Promise<void>;
...
/** @public */
export declare const defaultBindingUtils: TLAnyBindingUtilConstructor[];
...
/** @public */
export declare const defaultShapeTools: (typeof ArrowShapeTool)[];
...
/** @public */
export declare const defaultTools: (typeof EraserTool | typeof HandTool | typeof ZoomTool)[];
 ...
 * @public
 */
export declare function exportAs(editor: Editor, ids: TLShapeId[], format: TLExportType | undefined, name: string | undefined, opts?: TLSvgOptions): Promise<void>;
...
/** @public */
export declare function getAssetFromIndexedDb({ persistenceKey, assetId, }: {
    assetId: string;
...
/** @public @react */
export declare const PageItemInput: ({ name, id, isCurrentPage, }: PageItemInputProps) => JSX_2.Element;
...
/** @public */
export declare function storeAssetInIndexedDb({ persistenceKey, assetId, blob, }: {
    assetId: string;
    blob: Blob;
    persistenceKey: string;
}): Promise<void>;
...
/** @public */
export declare interface TldrawImageProps extends TLSvgOptions {
    /**
...
/** @public */
export declare type TldrawUiMenuContextType = 'context-menu' | 'helper-buttons' | 'icons' | 'keyboard-shortcuts' | 'menu' | 'panel' | 'small-icons' | 'toolbar-overflow' | 'toolbar';
...
/** @public */
export declare interface TldrawUiProps extends TldrawUiContextProviderProps {
    /**
     * The component's children.
     */
    children?: ReactNode;
...
/** @public */
export declare type TLUiEventHandler<T extends keyof TLUiEventMap = keyof TLUiEventMap> = (name: T, data: TLUiEventData<TLUiEventMap[T]>) => void;
