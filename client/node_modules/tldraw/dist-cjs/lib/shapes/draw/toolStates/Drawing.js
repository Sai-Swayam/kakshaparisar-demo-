...
class Drawing extends import_editor.StateNode {
  ...
  getIsClosed(segments, size) {
    ...
    return firstPoint !== lastPoint && this.currentLineLength > strokeWidth * 4 && import_editor.Vec.DistMin(firstPoint, lastPoint, strokeWidth * 2);
  }
  startShape() {
    const {
      inputs: { originPagePoint, isPen }
    } = this.editor;
    this.markId = "draw start " + (0, import_editor.uniqueId)();
