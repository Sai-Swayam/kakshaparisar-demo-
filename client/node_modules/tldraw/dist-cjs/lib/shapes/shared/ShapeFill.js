...
function PatternFill({ d, color, theme }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "path",
      {
        fill: svgExport ? `url(#${(0, import_defaultStyleDefs.getHashPatternZoomName)(1, theme.id)})` : teenyTiny ? theme[color].semi : `url(#${(0, import_defaultStyleDefs.getHashPatternZoomName)(zoomLevel, theme.id)})`,
        d
      }
    )
  ] });
